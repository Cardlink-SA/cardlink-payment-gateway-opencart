...
$_['entry_order_status']		= 'Κατάσταση Παραγγελίας (Captured/Purchase):';
$_['entry_preauth_order_status']= 'Κατάσταση Παραγγελίας (Pre-Auth / Σε Αναμονή):';
$_['text_preauth_order_status_note'] = '<br />Κατάσταση που ορίζεται όταν η πληρωμή είναι pre-authorized (δεν έχει γίνει ακόμα capture).';
$_['entry_failed_order_status'] = 'Κατάσταση Παραγγελίας (Αποτυχία / Ακύρωση):';
$_['text_failed_order_status_note'] = '<br />Κατάσταση που ορίζεται όταν η πληρωμή αποτύχει ή ακυρωθεί από τον πελάτη. Δεν αποστέλλεται email ειδοποίησης στον πελάτη σε αυτή την περίπτωση.';
$_['entry_xml_api']              = 'Λειτουργίες XML API:';
$_['text_xml_api_note']          = '<br />Ενεργοποιήστε για να επιτρέψετε capture, void και επιστροφές χρημάτων απευθείας από τη σελίδα Συναλλαγών.';
